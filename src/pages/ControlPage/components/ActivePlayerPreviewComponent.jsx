    ...
    <MDBCard border='light' style={{backgroundColor: '#BDBDBD'}}>
      ...
      <MDBCardBody>
        ...
        <MDBCardText>
          <MDBContainer>
            <MDBListGroup >
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Score:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.score !== "undefined" ? activePlayerData.score : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Goals:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.goals !== "undefined" ? activePlayerData.goals : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Assists:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.assists !== "undefined" ? activePlayerData.assists : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Saves:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.saves !== "undefined" ? activePlayerData.saves : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Shots:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.shots !== "undefined" ? activePlayerData.shots : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Boost:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.boost !== "undefined" ? activePlayerData.boost : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Speed:<MDBBadge color={activeColor}
                pill>{typeof activePlayerData !== "undefined" && typeof activePlayerData.speed !== "undefined" ? activePlayerData.speed : '0'}</MDBBadge>
              </MDBListGroupItem>
              <MDBListGroupItem color='dark' className="d-flex justify-content-between align-items-center">Teamname:<MDBBadge color={activeColor}
